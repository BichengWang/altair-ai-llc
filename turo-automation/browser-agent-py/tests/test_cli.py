...
class CliTests(unittest.TestCase):
    ...
    def test_main_supports_calendar_list_without_args(self) -> None:
        observed: list[list[str]] = []
        ...
        stdout = io.StringIO()
        with mock.patch.object(sys, "argv", ["turo-browser-agent", "calendar-list"]):
            with mock.patch.dict(cli.COMMANDS, {"calendar-list": handler}):
                with redirect_stdout(stdout):
                    exit_code = cli.main()
